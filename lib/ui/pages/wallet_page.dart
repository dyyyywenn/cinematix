...
class WalletPage extends StatelessWidget {
                        ...
                        BlocBuilder<UserBloc, UserState>(
                          builder: (_, userState) => Column(
                            children: <Widget>[
                              ...
                              FutureBuilder(
                                  future:
                                      CinematixTransactionServices.getTransaction(
  ...
  //meng generate list transaksi yang telah dilakukan
  Column generateTransactionList(
      List<CinematixTransaction> transactions, double width) {
